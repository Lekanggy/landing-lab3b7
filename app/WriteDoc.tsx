...
const WriteDoc = () => {
  return (
    ...
    <div className="flex flex-col justify-start items-start space-y-3">
        <span className="inline-flex text-left w-[400px] font-black text-[52px] max-[1024px]:text-[40px] leading-[60px] uppercase text-[#100F0F]">
            Write with docuhelp
        </span>
    ...
    <Image src={Edit} alt='logo' className='w-[600px]  h-[500px]  object-cover rounded-[40px] absolute right-0 bottom-0 max-[1024px]:w-[500px] max-[1024px]:h-[400px]'/>
</section>
  )
}
