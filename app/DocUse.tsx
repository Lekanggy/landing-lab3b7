  ...
  return (
    <section className="flex justify-between items-center relative p-10 mx-20 my-20 bg-white rounded-[40px] border-solid border-[#D2CEFD1A] shadow-ml">
        <div className="flex flex-col justify-start items-start space-y-3">
            ...
            <p className="text-[#1A0AD7] w-[500px] font-black text-[35px] uppercase border-t-8 border-[#1A0AD7] pt-3">
        ...
        <Image src={Edit2} alt='logo' className='w-[400px] h-[600px] object-cover  absolute right-11 bottom-0'/>
    </section>
  )
}
